...
export declare type StreamlabsWSEventPlatform = "streamlabs" | "twitch";
export declare type StreamlabsWSEventType = "follow" | "subscription" | "resubscription" | "bits" | "host" | "donation" | "raid" | "merch";
export declare type StreamlabsWSEventMessage = IStreamlabsDonation | ITwitchFollow | ITwitchBits | ITwitchSub | ITwitchSubGift | ITwitchRaid | ITwitchMerch | ITwitchHost;
export declare type StreamlabsWSEventFor = "streamlabs" | "twitch_account";
/**
